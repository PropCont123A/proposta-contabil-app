// NOVO ARQUIVO: app/components/ProfileMenu.tsx
'use client';
...
import './ProfileMenu.css'; // Criaremos este arquivo de CSS a seguir
    ...
    <div className="profile-menu-container" ref={menuRef}>
      ...
      {isOpen && (
        <div className="dropdown-menu">
          ...
          <Link href="/configuracoes/perfil" className="dropdown-item">
            <i className="fa-solid fa-user-cog"></i>
            <span>Meus Dados</span>
          </Link>
          <Link href="/configuracoes/escritorio" className="dropdown-item">
