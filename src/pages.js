...
// Atualizar função loadDashboard com layout original
        ...
        <div class="dashboard-content fade-in">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Propostas Enviadas</span>
                        <div class="stat-icon icon-purple">
                            <i class="fas fa-paper-plane"></i>
                        </div>
                    </div>
                    <div class="stat-value">${AppState.data.proposals.length}</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value">${getProposalsInNegotiation()}</div>
                    <div class="stat-change positive">+3 esta semana</div>
                </div>

                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Contratadas</span>
                        <div class="stat-icon icon-green">
                            <i class="fas fa-check-circle"></i>
                        </div>
                    </div>
                    <div class="stat-value">${getApprovedProposals()}</div>
                    <div class="stat-change positive">+5 este mês</div>
                </div>
            ...
            <div class="quick-actions">
                ...
                <div class="actions-grid">
                    <a href="#" class="action-btn" onclick="navigateTo('gerar-proposta')">
                        <i class="fas fa-plus"></i>
                        Nova Proposta
                    </a>
                    <a href="#" class="action-btn" onclick="navigateTo('minhas-propostas')">
                        <i class="fas fa-eye"></i>
                        Ver Propostas
                    </a>
                    <a href="#" class="action-btn" onclick="navigateTo('clientes')">
                        <i class="fas fa-user-plus"></i>
                        Novo Cliente
                    </a>
                    <a href="#" class="action-btn" onclick="navigateTo('configuracoes')">
...
// Funções auxiliares específicas do dashboard original
function getProposalsInNegotiation() {
    return AppState.data.proposals.filter(proposal => 
        proposal.status === 'em_negociacao' || proposal.status === 'enviada'
    ).length;
}

function getApprovedProposals() {
    return AppState.data.proposals.filter(proposal => 
        proposal.status === 'aprovada' || proposal.status === 'contratada'
    ).length;
}
